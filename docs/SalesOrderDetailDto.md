...
**invoiceStatus** | **string** |  | [optional] [default to undefined]
**invoiceAmountDue** | **number** |  | [optional] [default to undefined]
**lines** | [**Array&lt;SalesOrderLineDto&gt;**](SalesOrderLineDto.md) |  | [optional] [default to undefined]

## Example

```typescript
import { SalesOrderDetailDto } from '@kuzium/orbit-api-client';

const instance: SalesOrderDetailDto = {
    id,
    orderNumber,
    customerId,
    customerName,
